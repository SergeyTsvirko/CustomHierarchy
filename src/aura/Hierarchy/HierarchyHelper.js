({
        ...
        action.setCallback(this, function (response) {
            ...
            if (state == 'SUCCESS') {
                ...
                if (result.imageLink != null && result.imageLink.length > 0) {
                    ...
                    console.log('result.imageField ' + result.imageField);
                    if (result.imageField == null) {
                        console.log('result.imageField ' + result.imageField);
                ...
                component.set("v.childrenCount", result.childrenList.length);
                component.set("v.vchildren", vchildren.slice(0, maxChildrenScreen-2));
                component.set("v.itemchildren", result.childrenList);
            } else {
                console.log('ERROR');
            }
        });
    ...
    showChildrenConnector: function(component, helper, result, maxChildrenScreen) {
        if (result.childrenList.length >= maxChildrenScreen-1) {
        ...
        actionRecords.setCallback(this, function (response) {
            ...
            if (state == 'SUCCESS') {
                ...
                if (result != null && result.length > 0) {
                    component.set("v.filteredList", result);
                } else {
