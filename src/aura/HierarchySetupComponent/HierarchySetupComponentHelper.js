        ...
        if (component.get("v.recordId")) {
            ...
            action.setCallback(this, function (response) {
                ...
                if (state == 'SUCCESS') {
                    ...
                    component.set("v.childRelationList", settingResult.childRelationList);
                    component.set("v.parentRelationMap", settingResult.parentRelationMap);
